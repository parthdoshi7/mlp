...
def show_about():
    ...
    **Machine Learning Models and Accuracy:**
    ...
    - Naïve Bayes – Accuracy: 0.60
    - Gradient Boosting – Accuracy: 0.77
    - Random Forest – Accuracy: 0.88 (Used in final model)
    - Logistic Regression – Accuracy: 0.89 (Used in final model)
    ...
    **Hyperparameter Tuning Algorithms Accuracy:**
    - Decision Tree + Naïve Bayes – Accuracy: 0.79
    - Gradient Boosting + Logistic Regression – Accuracy: 0.66
    - Random Forest + Gradient Boosting – Accuracy: 0.69
    - Random Forest + Logistic Regression – Accuracy: 0.899 (Used in final model)
